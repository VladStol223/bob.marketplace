...
1. Does it express brand personality? → Motion Personality archetypes

1. Does it tell a story or guide attention? → Disney principles + choreography

1. Is this a complex multi-element scene? → 1/3 Rule + stagger patterns
...
1. **Motion Personality?** — Playful, Premium, Corporate, Energetic

1. **Primary property?** — position, scale, rotation, opacity

1. **Duration?** — see duration table below

1. **Easing family?** — entrance=decelerate, exit=accelerate

1. **Hero element?** — apply staging principles

1. **Secondary + ambient layers?** — add richness

1. **1/3 rules?** — motion distance, simultaneous elements
...
1. **Duration palette**: 3 durations (quick / standard / slow)

1. **Entrance pattern**: One consistent entry style
...
1. **Squash**: Scale to [1.04, 0.96] (100ms, ease-in)

1. **Follow through**: Overshoots to 1.02, settles to 1.0 (spring, 200ms)

1. **Secondary**: Shadow shrinks during press, icon shifts down 2px

1. **Total**: ~150ms press + 200ms settle

### Card Entrance (Premium)

1. **Start**: 20px below target, opacity 0

1. **Path**: Slight curve (10px X offset at midpoint)

1. **Easing**: ease-out-cubic deceleration

1. **Follow through**: Shadow arrives 50ms after card

1. **Secondary**: Content fades in 100ms after card lands

1. **Staging**: Other cards dim to 80%

### Success State (Playful)

1. **Primary**: Scale pop with ease-out-back

1. **Secondary**: Checkmark draws in

1. **Ambient**: Subtle particle burst
...
1. **Easing**: ease-in-out for sharp stops

1. **Color**: Red tint

1. **Total**: 300-400ms

1. **No overshoot**: Errors feel firm
...
1. **Never opacity-only** for important state changes — combine with position or scale

1. **Never exceed 1/3 screen** without intermediate keyframe

1. **Always three motion layers** — primary + secondary + ambient

### HIGH — strongly follow

1. Match duration to element type (see tables)

1. Use directional easing (ease-out entrance, ease-in exit)

1. Apply Disney principles (especially anticipation, follow-through)

1. Maintain consistent personality across scene
